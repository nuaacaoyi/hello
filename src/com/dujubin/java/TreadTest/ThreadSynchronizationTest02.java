 ...
 * 可能用途：  银行账户取款
 */
public class ThreadSynchronizationTest02 {//演示多人对同一个账户进行取款操作

    public static void main(String[] args) {
        Account2 a=new Account2("JACK",5000);
        Processor06 p=new Processor06(a);
...
class Account1{
    ...
    public synchronized void withdraw(double money){//将synchronized关键字放在成员方法上也可以，建议不采用该方法，因为方法中所有的多线程都无法使用
...
class Processor06 implements Runnable{
    ...
    public Processor06(Account2 act) {
        this.act = act;
    }
